...
<div class="w-64 absolute sm:relative bg-gray-800 shadow md:h-screen flex-col hidden sm:flex">
    <div class="px-4">
        <div class="h-16 w-full flex items-center justify-center">
            <h1 class="text-3xl text-gray-300">{{ env('APP_NAME') }}</h1>
        </div>
    </div>
...
<div
    class="overflow-y-auto w-64 z-40 absolute bg-gray-800 shadow h-screen flex-col justify-between sm:hidden translate-x-[-260px] transition duration-150 ease-in-out"
    id="mobile-nav">
    <div class="px-4">
        <div class="h-16 w-full flex items-center justify-center">
            <h1 class="text-3xl text-gray-300">{{ env('APP_NAME') }}</h1>
