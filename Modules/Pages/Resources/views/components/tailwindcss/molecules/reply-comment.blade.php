<hr class="my-2 border-gray-200" style="margin-left: {{ (4 * $index) . 'rem' }}">
<div class="flex flex-row pt-1 md-10" style="margin-left: {{ (4 * $index) . 'rem' }}">
    ...
    <div class="flex-col mt-1">
        <div class="flex items-center flex-1 px-4 font-bold leading-tight">{{ $comment->creator->name ?? 'Anonymous' }}
            <span
        ...
        <button class="inline-flex items-center px-1 pt-2 ml-1 flex-column" data-type="reply-button"
                data-parent-id="{{ $comment->id  }}" data-index="{{ $index }}">
            <svg
