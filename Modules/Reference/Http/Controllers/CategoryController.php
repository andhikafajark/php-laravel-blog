...
use Modules\Reference\Http\Requests\Category\CreateRequest;
use Modules\Reference\Http\Requests\Category\UpdateRequest;
...
class CategoryController extends Controller
{
    ...
    public function __construct(
        ...
        private string          $_route = 'category.',
        private string          $_routeView = 'category.',
    ...
    public function index(Request $request): View|Factory|JsonResponse|Application
    {
        if ($request->ajax()) {
            ...
            return $this->categoryService->getDatatable($data, $options);
        }
